...
class AboutClassMethods < Neo::Koan
  ...
  # The first form is more concise with less lines and less
  # indentation. The first form is also more readable because
  # the scope of the method definition not specified by the
  # enclosing singleton class block.
  #
