...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject combines all elements by the operation specified in
    # the block. If an argument is specified, it is used as the
    # initial value for the first iteration.

    # inject in ruby is like reduce in javascript
  end
