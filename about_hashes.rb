...
class AboutHashes < Neo::Koan
  ...
  def test_changing_hashes
    ...
    # Ruby thinks that { ... } is a block, so it should be "broken out into a variable", 
    # but you can always use assert_equal({ :one => "eins", :two => "dos" }, hash)
  ...
  def test_default_value
    ...
    assert_equal "dos", hash2[:two] # any new keys will have a default value
  end
