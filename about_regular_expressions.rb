...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Never (?) as * can always match an empty string.
  end
  ...
  # Repetition operators matches as much as possible (from left to right)
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    ...
    # digit character in a string, and returns a string
  end
  ...
  def test_slash_s_is_a_shortcut_for_a_whitespace_character_class
    assert_equal " \t\n", "space: \t\n"[/\s+/]
    # \t is tab character, \n is newline character, both are whitespace characters
  end
  ...
  # The character class allows for a range of characters to be matched while
  # alternations can be more specific and only match a specified sequence of characters.
  # e.g. [A-z]+ vs (cat|dog)
