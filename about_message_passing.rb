...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # The send method may be overriden by some classes which does not behave
    # like the original send. __send__ is provided in case the send method is
    # redefined by other class.
